...
\end{frame}
\begin{frame}{Rozkład czasu obserwacji}\centering\widefig{01_rozklad_czasu.pdf}\end{frame}
...
\begin{frame}{Tabela Kaplana-Meiera}
Tabela Kaplana-Meiera umożliwia kontrolę punktowych estymacji funkcji przeżycia w kolejnych czasach zdarzeń. Obserwacje cenzurowane zmniejszają liczebność zbioru ryzyka, ale nie powodują skoku funkcji przeżycia.
\end{frame}
\begin{frame}{Tablica aktuarialna}
Tablica aktuarialna grupuje czas obserwacji w przedziały i pozwala syntetycznie opisać prawdopodobieństwo przeżycia oraz intensywność zdarzeń w kolejnych okresach. W przeciwieństwie do Kaplana-Meiera wynik zależy od przyjętej szerokości przedziałów.
\end{frame}
...
\begin{frame}{Profile przeżycia w modelu AFT}\centering\widefig{07_aft_profile_survival.pdf}\\[-.3em]{\scriptsize Profil wysokiego ryzyka charakteryzuje się szybszym spadkiem funkcji przeżycia.}\end{frame}
\begin{frame}{Hazard w modelu AFT}\centering\widefig{08_aft_profile_hazard.pdf}\end{frame}
...
\begin{frame}{Traceploty MCMC}\centering\widefig{08d_bayes_traceplots.pdf}\end{frame}
...
\begin{frame}{Predykcja funkcji przeżycia z modelu Coxa}\centering\widefig{11_cox_profile_survival.pdf}\end{frame}
